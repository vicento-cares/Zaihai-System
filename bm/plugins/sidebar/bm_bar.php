<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="applicator_in.php" class="brand-link">
    ...
    <span class="brand-text font-weight-light">Zaihai | BM</span>
  </a>
  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <?php if ($_SERVER['REQUEST_URI'] == "/zaihai/bm/applicator_in.php") { ?>
        ...
        <li class="nav-item">
          <?php if ($_SERVER['REQUEST_URI'] == "/zaihai/bm/applicator_checksheet.php") { ?>
        ...
        <li class="nav-item">
          <?php if ($_SERVER['REQUEST_URI'] == "/zaihai/bm/applicator_history.php") { ?>
