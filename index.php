                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            ...
                            <li><a href="viewer/applicator_shots.php" class="dropdown-item">Applicator Shots</a></li>
                            ...
                            <li><a href="viewer/applicator_pd_verification.php" class="dropdown-item">Applicator PD Verification</a></li>
                            <li class="d-none"><a href="viewer/applicator_err_mon.php" class="dropdown-item">Applicator Error Monitoring</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
