<!-- Data Info Modal -->
<div class="modal fade" id="applicator_checksheet_verify" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header bg-dark">
        <h4 class="modal-title">MEI-295 (AC) Verify Applicator Checksheet</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span class="text-white" aria-hidden="true">&times;</span>
        </button>
      </div>
      <form id="applicator_checksheet_verify_form">
        <div class="modal-body">
          <div class="row">
            <div class="col-sm-5">
              <div class="form-group">
                <label>Serial No. : </label>
                <span id="serial_no_acver" class="ml-2"></span>
              </div>
            </div>
            <div class="col-sm-7">
              <div class="form-group">
                <label>Equipment No. (F. No.) : </label>
                <span id="equipment_no_acver" class="ml-2"></span>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-5">
              <div class="form-group">
                ...
                <span id="machine_no_acver" class="ml-2"></span>
              </div>
            </div>
            <div class="col-sm-7">
              <div class="form-group">
                <label>Terminal Name : </label>
                <span id="terminal_name_acver" class="ml-2"></span>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-5">
              <div class="form-group">
                ...
                <span id="inspection_date_acver" class="ml-2"></span>
              </div>
            </div>
            <div class="col-sm-4">
              <div class="form-group">
                <label>Inspection Time : </label>
                <span id="inspection_time_acver" class="ml-2"></span>
              </div>
            </div>
            <div class="col-sm-3">
              <div class="form-group">
                <label>Inspection Shift : </label>
                <span id="inspection_shift_acver" class="ml-2"></span>
              </div>
            </div>
          </div>
          <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-lg-1 col-sm-12">
              <div class="form-group mb-0">
                <label class="h4" id="ac1_acver"></label>
              </div>
            </div>
            <div class="col-lg-2 col-sm-12">
              <div class="form-group mb-0">
                <p id="cont_1s_acver"></p>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-12">
              <div class="form-group mb-0">
                <p id="cont_1r_acver">Replace Details: </p>
              </div>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-lg-1 col-sm-12">
              <div class="form-group mb-0">
                <label class="h4" id="ac2_acver"></label>
              </div>
            </div>
            <div class="col-lg-2 col-sm-12">
              <div class="form-group mb-0">
                <p id="cont_2s_acver"></p>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-12">
              <div class="form-group mb-0">
                <p id="cont_2r_acver">Replace Details: </p>
              </div>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-lg-1 col-sm-12">
              <div class="form-group mb-0">
                <label class="h4" id="ac3_acver"></label>
              </div>
            </div>
            <div class="col-lg-2 col-sm-12">
              <div class="form-group mb-0">
                <p id="cont_3s_acver"></p>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-12">
              <div class="form-group mb-0">
                <p id="cont_3r_acver">Replace Details: </p>
              </div>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-lg-1 col-sm-12">
              <div class="form-group mb-0">
                <label class="h4" id="ac4_acver"></label>
              </div>
            </div>
            <div class="col-lg-2 col-sm-12">
              <div class="form-group mb-0">
                <p id="cont_4s_acver"></p>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-12">
              <div class="form-group mb-0">
                <p id="cont_4r_acver">Replace Details: </p>
              </div>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-lg-1 col-sm-12">
              <div class="form-group mb-0">
                <label class="h4" id="ac5_acver"></label>
              </div>
            </div>
            <div class="col-lg-2 col-sm-12">
              <div class="form-group mb-0">
                <p id="cont_5s_acver"></p>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-12">
              <div class="form-group mb-0">
                <p id="cont_5r_acver">Replace Details: </p>
              </div>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-lg-1 col-sm-12">
              <div class="form-group mb-0">
                <label class="h4" id="ac6_acver"></label>
              </div>
            </div>
            <div class="col-lg-2 col-sm-12">
              <div class="form-group mb-0">
                <p id="cont_6s_acver"></p>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-12">
              <div class="form-group mb-0">
                <p id="cont_6r_acver">Replace Details: </p>
              </div>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-lg-1 col-sm-12">
              <div class="form-group mb-0">
                <label class="h4" id="ac7_acver"></label>
              </div>
            </div>
            <div class="col-lg-2 col-sm-12">
              <div class="form-group mb-0">
                <p id="cont_7s_acver"></p>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-12">
              <div class="form-group mb-0">
                <p id="cont_7r_acver">Replace Details: </p>
              </div>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-lg-1 col-sm-12">
              <div class="form-group mb-0">
                <label class="h4" id="ac8_acver"></label>
              </div>
            </div>
            <div class="col-lg-2 col-sm-12">
              <div class="form-group mb-0">
                <p id="cont_8s_acver"></p>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-12">
              <div class="form-group mb-0">
                <p id="cont_8r_acver">Replace Details: </p>
              </div>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-lg-1 col-sm-12">
              <div class="form-group mb-0">
                <label class="h4" id="ac9_acver"></label>
              </div>
            </div>
            <div class="col-lg-2 col-sm-12">
              <div class="form-group mb-0">
                <p id="cont_9s_acver"></p>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-12">
              <div class="form-group mb-0">
                <p id="cont_9r_acver">Replace Details: </p>
              </div>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-lg-1 col-sm-12">
              <div class="form-group mb-0">
                <label class="h4" id="ac10_acver"></label>
              </div>
            </div>
            <div class="col-lg-2 col-sm-12">
              <div class="form-group mb-0">
                <p id="cont_10s_acver"></p>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-12">
              <div class="form-group mb-0">
                <p id="cont_10r_acver">Replace Details: </p>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-lg-4 col-sm-12">
              <div class="form-group">
                ...
                <p id="adjustment_content_acver"></p>
              </div>
            </div>
            <div class="col-lg-8 col-sm-12">
              <div class="form-group">
                <label>Content of Adjustment / Repair (Remarks): </label>
                <p id="adjustment_content_remarks_acver"></p>
              </div>
            </div>
          </div>
          <div class="row mb-2">
            ...
            <div class="col-lg-3 col-sm-12">
              <div class="form-group mb-0">
                <label class="h4" id="cross_section_result_acver"></label>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group mt-1 mb-0">
                ...
                <span id="inspected_by_acver" class="ml-2"></span>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group mt-1 mb-0">
                <label>Checked By : </label>
                <span id="checked_by_acver" class="ml-2"></span>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group mt-1 mb-0">
                ...
                <span id="confirmed_by_no_acver" class="ml-2"></span>
              </div>
            </div>
          </div>
          <div class="row mb-2">
            ...
            <div class="col-lg-1 col-sm-12">
              <div class="form-group mb-0">
                <label class="h4" id="judgement_acver"></label>
              </div>
            </div>
          </div>
        </div>
        <div class="modal-footer bg-light">
          <button type="submit" id="btnVerifyAc" name="btn_verify_ac" class="btn btn-success btn-block">Verify</button>
        </div>
      </form>
    </div>
    <!-- /.modal-content -->
