<script type="text/javascript">
    ...
    const get_car_maker_dropdown = () => {
		$.ajax({
			...
			success: response => {
				document.getElementById("term_car_maker_master").innerHTML = response;
                document.getElementById("term_car_maker_master_update").innerHTML = response;
			}
		});
	}
	...
	const get_car_model_dropdown = () => {
		$.ajax({
			...
			success: response => {
                document.getElementById("term_car_model_master").innerHTML = response;
				document.getElementById("term_car_model_master_update").innerHTML = response;
			}
		});
	}
