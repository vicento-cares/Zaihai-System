          ...
          <div class="card card-gray-dark card-outline">
            ...
            <div class="card-body">
              <div class="row mb-4">
                ...
                <div class="col-sm-3">
                  <label>Role</label>
                  <select id="ai_role_search" class="form-control" onchange="get_accounts()">
              ...
              <div class="row mb-2">
                ...
                <div class="col-sm-3">
                  <button type="button" class="btn btn-success btn-block" onclick="get_accounts()"><i class="fas fa-search"></i> Search</button>
                </div>
              </div>
              <div class="row mb-2">
                <div class="col-sm-2">
